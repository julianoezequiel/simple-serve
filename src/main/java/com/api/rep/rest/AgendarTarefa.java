...
public class AgendarTarefa extends ApiRestController {
	...
	public Tarefa biometria(@RequestBody UsuarioBioCmd usuarioBioCmd, @PathVariable String operacao)
		...
		if (operacao.equalsIgnoreCase("enviar") && usuarioBio2 == null
				|| (operacao.equalsIgnoreCase("enviar") && usuarioBio2 != null && usuarioBio2.getTemplate() == null)) {
		...
		if (usuarioBio2 != null) {
			...
			this.usuarioBioRepository.save(usuarioBio);
